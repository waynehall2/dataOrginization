...
bold_font_size_14 = Font(bold=True, size=14)

# Add the definitions data to the "Key" sheet
definitions_data = [
    ["Level - Definition"],
    ["Beginner - I understand the basics."],
    ["Intermediate - I apply this skill in my work and continue to learn more."],
    ["Advanced - I have applied the skill in multiple contexts and can educate others."],
    ["Expert - I have deep knowledge, design solutions, can solve complex problems and/or lead others in this area."],
    ["Master - I am a key influencer, establishing the vision and/or shaping the future in this area."]
]

for row_index, row_data in enumerate(definitions_data, start=1):
    for col_index, cell_data in enumerate(row_data, start=1):
        cell = definitions_sheet.cell(row=row_index, column=col_index, value=cell_data)
        cell.font = bold_font_size_14

# Set the "Skills" sheet as the active sheet 
wb.active = wb['Skills']
